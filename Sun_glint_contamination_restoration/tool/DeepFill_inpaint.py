...
def parse_arges():
    ...
    parser.add_argument('--pretrained_model', type=str,
                        default='D:/A_test/Sun-Glint-Correction/Sun_glint_contamination_restoration/weight/imagenet_deepfill.pth')
    parser.add_argument('--test_img', type=str,
                        default='D:/A_test/Sun-Glint-Correction/Sun_glint_contamination_restoration/data/glint/0.png')
    parser.add_argument('--test_mask', type=str,
                        default='D:/A_test/Sun-Glint-Correction/Sun_glint_contamination_restoration/data/label/0.png')
    parser.add_argument('--output_path', type=str,
                        default='D:/A_test/Sun-Glint-Correction/Sun_glint_contamination_restoration/result/frame_inpaint/glint/0.png')
...
def main():
    ...
    deepfill = DeepFillv2(pretrained_model=args.pretrained_model,
